...
namespace SolutionPersonnelleTemplate.Models.BLL.Managers
{
    public class MessageRepository : IRepositoryMessage
    {
        ...
        public async Task<bool> LeMessageEstILLePremierMessageDeLHistoire(int histoireID)
        {
            Message premierMessageDeLHisoireExist = await _context.Messages
               .Where(h => h.HistoireID == histoireID).Where(m => m.EstLePremierMessageDeLHistoire == true).FirstOrDefaultAsync();

            if (premierMessageDeLHisoireExist != null)
            {
                return true;
            }
            else
        ...
        {
            Message premierMessageDeLHisoire = await _context.Messages
                .Where(h => h.HistoireID == histoireID).Where(m => m.EstLePremierMessageDeLHistoire==true).FirstOrDefaultAsync();


            return premierMessageDeLHisoire;
        ...
        public async Task<bool> PeuplerLesMessagesDesHistoire()
        {
            ...
            using (var transaction = db.Database.BeginTransaction())
            {
                ...
                Message message1Histoire1 = new Message
                {
                    ...
                    EstLePremierMessageDeLHistoire =true
                };
                ...
                Message message2Histoire1 = new Message
                {
                    ...
                    DateCreationMessage = DateTime.Now,
                    EstLePremierMessageDeLHistoire = false
                };
        ...
        public async Task<Message> NouveauMessage(Message messageModele)
        {
            Message messageAAjouter = new Message
            {
                ...
                DateCreationMessage = DateTime.Now,
                EstLePremierMessageDeLHistoire = messageModele.EstLePremierMessageDeLHistoire
            };
