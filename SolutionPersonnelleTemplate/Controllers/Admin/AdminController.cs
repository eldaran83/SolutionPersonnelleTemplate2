...
namespace SolutionPersonnelleTemplate.Controllers.Admin
{
    ...
    public class AdminController : Controller
    {
        ...
        {
            //peuple la bdd de 3 utilisateurs test 
            var combienDeUtilisateurEnBDD = _context.Utilisateurs.Count();
            if (combienDeUtilisateurEnBDD < 3)
            {
                await _utilisateurManager.PeuplerLaBddAvec3typesUtilisateur();
            }
